                                ...
                                <div class="portlet light bg-inverse">
                                    <div class="portlet-title">
                                        <div class="caption font-green-sharp">
                                            ...
                                            <span class="caption-subject"> {{ session('contact_center_admin.0.name') }}</span>
                                            <span class="caption-helper">@if(Request::url()  == url('/pending_panic')) Open Panic @else Completed Panic @endif</span>
                                        </div>
                                                            ...
                                                            <tbody>
                                                                @foreach($videos as $video)
                                                                    <tr>
                                                                        ...
                                                                        <td><button tabindex="0" role="button" data-trigger="focus" type="button" class="btn btn-fb panic-note btn-fb" data-toggle="popover" onclick="showNote(this)"  data-placement="top" title="User Notes" data-content="{{ $video->notes?$video->notes:"N/A" }}">View Notes</button></td>
                                                                        <td>
                                                                            <div class="btn-group">
