                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td >{{$notification->created_at}}</td>
                                                                      <td><a tabindex="0" role="button" data-trigger="focus" class="btn btn-primary btn-xs mn-popop" onclick="showMNpopup(this)" data-toggle="popover"  data-placement="top" title="{{ $notification->title }} Note" data-content="{{ $notification->notes?$notification->notes:"N/A" }}">View Notes</a></td>
                                                                    <td>
                                                                        <div class="">
