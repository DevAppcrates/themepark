...
<!-- BEGIN THEME GLOBAL SCRIPTS -->
 ...
 <!-- BEGIN THEME LAYOUT SCRIPTS -->
  ...
  selectionHeader: "<a href='#' id='deselect-all'>Deselect All</a><input type='text' class='search-input form-control btn-circle' autocomplete='off' placeholder='Search to Deselect'>",
