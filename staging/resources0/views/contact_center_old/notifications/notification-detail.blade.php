               ...
               <div class="portlet-body" >
                  <div class="row">
                     ...
                     <div style="float: right;" class="col-sm-5 col-xs-8">
                        <h2><small class="text-muted">Initiated By:</small></h2>
                        <h3 >{!! $notification_detail['sent_by']['name']?$notification_detail['sent_by']['name']:$notification_detail['name'] !!}</h3>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-sm-6">
                        <div class="row">
                           <div class="col-sm-12">
                              ...
                              style="min-height: 330px;" @endif>{{ $notification_detail->notification?$notification_detail->notification:'N/A' }}</textarea>
                           </div>
            ...
            <div class="row">
               <div class="col-xs-12 col-md-12 col-sm-4">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <div class="caption">
                           <i class="fa fa-globe"></i>Group List
                        </div>
                     </div>
