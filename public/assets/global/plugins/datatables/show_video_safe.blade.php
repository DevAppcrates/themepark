...
{{-- <div class="container-fluid " style="background-color: #fff;">
    <div class="col-sm-6" style="color: #fff;">
        ...
        <div id="videos" style="margin-top: 27px">
        @if($video->type=='panic')
            @php
          ...
          <div class="col-sm-12">
              <br/>
              <h3 style="margin-bottom: -25px"><img class="img-circle img-thumbnail" src="{{$user->display_picture}}" align="left"  style=" width: 70px;height: 70px; margin-right: 10px;object-fit: contain; margin-bottom: 10px;margin-top: -15px;"> {{$user->first_name}} {{$user->last_name}}</h3>
              <br>
              <br>
        ...
        <br>
            ...
            <div id="soon" style="display: none">
                <img src="{{url('/')}}/public/images/soon.jpg" class="img-responsive" style="height: 292px;width: 100%;">
            </div>
        </div>
