    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6" align="center" style="margin-top: -8px;">
               <h3 class="page-title"> @if($video->type=='panic')<strong>PANIC @elseif($video->type == 'anonymous') ANONYMOUS TIP @else LOST PERSON @endif ALERT DETAILS</strong></h3>
            </div>
        ...
        <div class="row">
            <div @if($video->type == 'panic') class="col-md-7" @else class="col-md-6" @endif>
                ...
                <h3 class="h3">IMAGE</h3>
                    ...
                    <br>
                    <br>
                    <h3 class="h3">Lost Person Detail:</h3>
                    @if(!empty($video->lost_person))
                        <div class="p-3 location" style="padding: 10px !important;height: auto;">
                             @if(isset($video->lost_person['name']))
                                <label class="form-label">Name of Lost Person</label>
                                <input class="form-control" type="text" name="name" id="l_name" value="<?php echo $video->lost_person['name']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_person['gender']))
                                <label class="form-label">Gender</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_person['gender']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_person['age']))
                                <label class="form-label">Age</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_person['age']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_person['race']))
                                <label class="form-label">Race</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_person['race']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_person['hair_color']))
                                <label class="form-label">Hair Color</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_person['hair_color']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_person['time_last_seen']))
                                <label class="form-label">Time Last Seen</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_person['time_last_seen']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_person['place_last_seen']))
                                <label class="form-label">Place Last Seen</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_person['place_last_seen']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_person['contact_phone']))
                                <label class="form-label">Contact Number</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_person['contact_phone']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_person['contact_name']))
                                <label class="form-label">Contact Name</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_person['contact_name']??'' ?>"><br/>
                             @endif
                            @if(isset($video->lost_person['description']))
                                <label class="form-label">Description/Notes</label>
                                <textarea class="form-control" style="min-height:150px"><?php echo $video->lost_person['description']??'' ?></textarea>
                             @endif
                       ...
                       <div class="p-3 location text-center" style="padding: 10px !important;height: 200px;text-align: center;display: flex;justify-content: center;flex-direction: column;">
                           ...
                           <h3>Lost person detail not found!</h3>
                       </div>
                   @endif
                @endif
            </div>
