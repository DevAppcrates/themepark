...
$values = basename(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH));
    $url = 'https://ifollow-themeparkalert.firebaseio.com/.json?orderBy="isActive"&equalTo=true';
    $ch = curl_init();
    ...
    $videos = \App\Videos::with('user')->where('archive_id', '!=', '')->where('type', '=', 'lost_person')->whereIn('user_id', $user_ids)->whereIn('video_id', $video_ids)->paginate(20);
?>
                                ...
                                <div class="portlet light bg-inverse">
                                    <div class="portlet-title">
                                        <div class="caption font-green-sharp">
                                            ...
                                            <span class="caption-subject">Lost Persons</span>
